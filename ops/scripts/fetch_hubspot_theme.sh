...
# comparison or recovery. Does not replace customer-portal/theme/ (HubSpot fetch
...
#
# Same remote name as portal_task_complete.sh / HUBSPOT_THEME_DEST (default: customer-portal).
set -euo pipefail
...
THEME_SRC="${HUBSPOT_THEME_DEST:-customer-portal}"
...
echo "  diff -qr $OUT_DIR customer-portal/theme"
