...
```bash
INIT=$(node "/Users/vMac/00-hair-solutions-co/00_engineering/04_hubspot/99-development/design-manager/customer-portal/.cursor/get-shit-done/bin/gsd-tools.cjs" init new-workspace)
