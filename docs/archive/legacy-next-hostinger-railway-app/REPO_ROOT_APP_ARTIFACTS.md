...
The **HubSpot CMS** upload target is **`hair-solutions-portal/`** (and related **`theme/`**). These paths are **not** uploaded as theme files; they exist for the old **Next.js** stack and shared Node tooling.
